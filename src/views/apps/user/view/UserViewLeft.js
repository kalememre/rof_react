        ...
        <Grid item xs={12}>
          <Card>
            <CardContent sx={{ pt: 13.5, display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
              <CircleFlag countryCode={user?.user_profile?.country.toLowerCase()} height='100' width='100' />
              <Typography variant='h4' sx={{ mb: 3 }}>
                {user.fullName}
              </Typography>
              <Box sx={{
                borderRadius: 1,
                bgcolor: user.user_profile?.role.color,
                p: 1,
              }}>
                <Typography color={'white'}>
                  {user.user_profile?.role.name}
                </Typography>
              </Box>
            </CardContent>
            ...
            <CardContent sx={{ pb: 4 }}>
              ...
              <Box sx={{ pt: 4 }}>
                ...
                <Box sx={{ display: 'flex', mb: 3 }}>
                  ...
                  <Typography sx={{ color: 'text.secondary' }}>{user?.user_profile?.phone}</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 3, alignItems: 'center' }}>
                  ...
                  <CustomChip
                    ...
                    color={statusColors[user.is_active]}
                    sx={{
                ...
                <Box sx={{ display: 'flex', mb: 3 }}>
                  ...
                  <Typography sx={{ color: 'text.secondary' }}>{user?.user_profile?.PPSN}</Typography>
                </Box>
                <Box sx={{ display: 'flex', mb: 3 }}>
